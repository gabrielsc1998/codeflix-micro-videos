import { DataGenerator } from "#seedwork/infra";
...
export class CategoryFakeBuilder<TBuild = any> {
  ...
  private _name: PropOrFactory<string> = (_index) => this.dataGenerator.word();
  private _description: PropOrFactory<string | null> = (_index) =>
    this.dataGenerator.text();
  ...
  private dataGenerator: typeof DataGenerator;
  ...
  withInvalidNameTooLong(value?: string) {
    this._name = value ?? this.dataGenerator.word({ length: 256 });
    return this;
  }
