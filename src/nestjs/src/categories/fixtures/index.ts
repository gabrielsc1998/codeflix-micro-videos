...
import { UNPROCESSABLE_ENTITY } from '../../@share/errors/errors.http';
  ...
  static arrangeInvalidRequest() {
    ...
    return {
      EMPTY: {
        send_data: {},
        expected: {
          message: [cannotBeEmpty('Name'), mustBeAString('Name')],
          ...defaultExpected,
        },
      },
      NAME_UNDEFINED: {
